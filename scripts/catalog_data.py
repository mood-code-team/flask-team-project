...
CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "children": [
            ...
            {"name": "4인소파", "slug": "sofa-4", "sort_order": 3},
            {"name": "리클라이너", "slug": "recliner", "sort_order": 4},
            {"name": "코너소파", "slug": "corner-sofa", "sort_order": 5},
            {"name": "암체어", "slug": "armchair", "sort_order": 6},
            {"name": "안락의자", "slug": "lounge-chair", "sort_order": 7},
            {"name": "소파 기타", "slug": "sofa-other", "sort_order": 8},
        ],
        "products": [
            ...
            {"name": "패밀리 4인 소파", "slug": "family-sofa-4", "category": "sofa-4", "price": 1120000, "discount_price": 998000, "filter_space": "living", "filter_style": "fall", "filter_color": "gray", "brand": "Mood Code"},
            {"name": "코너형 리클라이너 소파", "slug": "corner-recliner", "category": "recliner", "price": 1350000, "discount_price": 1190000, "is_new": True, "is_best": True, "filter_space": "living", "filter_style": "summer", "filter_color": "gray", "brand": "Mood Code"},
            {"name": "L형 코너소파", "slug": "l-corner-sofa", "category": "corner-sofa", "price": 1580000, "is_popular": True, "has_installation": True, "filter_space": "living", "filter_style": "winter", "filter_color": "black", "brand": "Mood Code"},
        ],
    },
    {
        "name": "Side Table",
    ...
    },
    {
        ...
        "products": [
            {"name": "우드 디퓨저 세트", "slug": "wood-diffuser-set", "category": "potpourri", "price": 68000, "is_popular": True, "is_new": True, "filter_space": "living", "filter_style": "spring", "filter_color": "wood", "brand": "Mood Code"},
            {"name": "스톤 아로마 디퓨저", "slug": "stone-aroma-diffuser", "category": "sachet", "price": 92000, "is_best": True, "filter_space": "balcony", "filter_style": "winter", "filter_color": "gray", "brand": "Mood Code"},
            {"name": "리드 캔들 디퓨저", "slug": "reed-candle-diffuser", "category": "glass-candle", "price": 45000, "is_popular": True, "filter_space": "balcony", "filter_style": "fall", "filter_color": "beige", "brand": "Mood Code"},
            {"name": "린넨 룸스프레이", "slug": "linen-room-spray", "category": "mini-candle", "price": 32000, "is_new": True, "filter_space": "bedroom", "filter_style": "summer", "filter_color": "white", "brand": "Mood Code"},
        ],
    },
    {
        "name": "Dining Table",
    ...
    },
    {
        ...
        "children": [
            ...
            {"name": "침대프레임", "slug": "bed-frame", "sort_order": 7},
            {"name": "침대 기타", "slug": "bed-other", "sort_order": 8},
        ],
        "products": [
    ...
    },
    {
        ...
        "products": [
            ...
            {"name": "우드 발코니 벤치", "slug": "balcony-wood-bench", "category": "outdoor-table", "price": 156000, "is_popular": True, "filter_space": "balcony", "filter_style": "spring", "filter_color": "wood", "brand": "Mood Code"},
            {"name": "발코니 수납 선반", "slug": "balcony-storage-shelf", "category": "shelf-unit", "price": 89000, "filter_space": "balcony", "filter_style": "fall", "filter_color": "white", "brand": "Mood Code"},
