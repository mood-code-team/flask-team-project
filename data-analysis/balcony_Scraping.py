"""
IKEA 발코니/야외용품 상품 수집기 - (검색 결과 기반 & 색상 옵션 수집 지원)

[업그레이드 내용]
- 카테고리 메뉴가 아닌 '검색 결과(Search)' 페이지를 타겟으로 변경하여 누락 없이 수집합니다.
- '발코니', '야외', '조립마루' 키워드 검색 결과를 순회하며 목표 개수를 채웁니다.
"""
...
# ==================================================
# 1. 기본 설정 (★검색 URL 기반으로 세팅★)
# ==================================================

CATEGORY_NAME = "BALCONY_OUTDOOR"

# '카테고리' 대신 실제 이케아 검색창에 쳤을 때 나오는 '검색 결과' 주소들을 사용합니다.
CATEGORY_URLS = [
    f"https://www.ikea.com/kr/ko/search/?q={quote('발코니')}",
    f"https://www.ikea.com/kr/ko/search/?q={quote('야외')}",
    f"https://www.ikea.com/kr/ko/search/?q={quote('조립마루')}"
]

MAX_PRODUCTS = 100
OUTPUT_FOLDER = "output_balcony"
IMAGE_FOLDER = os.path.join(OUTPUT_FOLDER, "images")
OUTPUT_EXCEL_FILE = "balcony_100_products.xlsx"
OUTPUT_CSV_FILE = "balcony_100_products.csv"
CHECKPOINT_FILE = "balcony_checkpoint.csv"
