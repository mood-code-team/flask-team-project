"""
IKEA 식탁(Dining Table) 통합 상품 수집기 - (다중 카테고리 & 색상 옵션 수집 지원)

[카테고리 구성]
- 일반 식탁, 식탁+의자 세트, 바 테이블, 카페 테이블을 모두 순회하며 수집합니다.
"""
...
# ==================================================
# 1. 기본 설정 (★식탁 맞춤형 다중 카테고리 세팅★)
# ==================================================

CATEGORY_NAME = "DINING_TABLE"

# 이케아의 식탁 관련 다양한 카테고리 주소 리스트
CATEGORY_URLS = [
    "https://www.ikea.com/kr/ko/cat/dining-tables-21825/",  # 일반 식탁
    "https://www.ikea.com/kr/ko/cat/dining-sets-19145/",    # 식탁 세트(의자 포함)
    "https://www.ikea.com/kr/ko/cat/bar-tables-20862/",     # 바 테이블
    "https://www.ikea.com/kr/ko/cat/cafe-tables-furgb01/"   # 카페 테이블
]

MAX_PRODUCTS = 100
OUTPUT_FOLDER = "output_dining_table"
IMAGE_FOLDER = os.path.join(OUTPUT_FOLDER, "images")
OUTPUT_EXCEL_FILE = "dining_table_100_products.xlsx"
OUTPUT_CSV_FILE = "dining_table_100_products.csv"
CHECKPOINT_FILE = "dining_table_checkpoint.csv"
