"""
IKEA 조명(Lighting) 상품 수집기 - (검색 결과 기반 & 색상 옵션 수집 지원)

[업그레이드 내용]
- '조명', '스탠드', '전등' 3가지 핵심 키워드 검색 결과를 순회하며 목표 개수를 채웁니다.
- 단일 스탠드부터 스마트 조명, 천장 펜던트 조명까지 다양한 상품이 수집됩니다.
"""
...
# ==================================================
# 1. 기본 설정 (★조명 검색 URL 기반 세팅★)
# ==================================================

CATEGORY_NAME = "LIGHTING"

# 다양한 형태의 조명을 놓치지 않기 위해 3가지 검색어를 순회합니다.
CATEGORY_URLS = [
    f"https://www.ikea.com/kr/ko/search/?q={quote('조명')}",
    f"https://www.ikea.com/kr/ko/search/?q={quote('스탠드')}",
    f"https://www.ikea.com/kr/ko/search/?q={quote('전등')}"
]

MAX_PRODUCTS = 100
OUTPUT_FOLDER = "output_lighting"
IMAGE_FOLDER = os.path.join(OUTPUT_FOLDER, "images")
OUTPUT_EXCEL_FILE = "lighting_100_products.xlsx"
OUTPUT_CSV_FILE = "lighting_100_products.csv"
CHECKPOINT_FILE = "lighting_checkpoint.csv"
